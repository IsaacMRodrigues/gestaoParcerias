            ...
            <div class="flex items-center justify-between h-16">
                ...
                <nav class="flex items-center gap-6 text-sm">
                    ...
                    @auth
                        ...
                        <span class="text-indigo-400 text-xs hidden sm:inline">
                            {{ auth()->user()->name }}
                        </span>
                        ...
                        <form method="POST" action="{{ route('logout') }}">
                            @csrf
                            <button type="submit"
                                    class="text-indigo-200 hover:text-white border border-indigo-500 hover:border-white px-3 py-1 rounded text-sm transition">
                                Sair
                            </button>
                        </form>
                    @else
