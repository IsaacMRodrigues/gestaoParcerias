...
<body class="antialiased text-gray-800">
    ...
    <div class="min-h-screen flex flex-col bg-gradient-to-br from-indigo-950 via-indigo-900 to-purple-900 text-white">
        ...
        <div class="relative flex-1 flex items-center justify-center px-4 py-14">
            <div class="w-full max-w-5xl text-center">
                ...
                <div class="flex items-center justify-center gap-3 mb-8">
                    <span class="w-12 h-12 bg-white rounded-xl flex items-center justify-center text-indigo-800 font-black shadow-lg">PGP</span>
                    <span class="text-left leading-tight">
                        <span class="block font-semibold text-lg">Gestão de Parcerias</span>
                        <span class="block text-xs text-indigo-300">Prefeitura de São Gonçalo do Rio Abaixo</span>
                    </span>
                </div>
                ...
                <p class="mt-2 text-lg sm:text-xl text-indigo-200 font-medium">
                    Organizações da Sociedade Civil
                </p>

                <p class="mt-6 max-w-3xl mx-auto text-sm sm:text-base text-indigo-100/90 leading-relaxed">
                ...
                <div class="mt-10 grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-3xl mx-auto">
                    <a href="{{ route('login') }}"
                       class="group flex items-center justify-center gap-3 px-6 py-4 rounded-full bg-white/95 text-indigo-900 font-semibold shadow-lg hover:bg-white hover:-translate-y-0.5 transition">
                ...
                <div class="mt-4 grid grid-cols-1 sm:grid-cols-3 gap-4 max-w-3xl mx-auto">
                    <a href="{{ route('portal.index') }}"
                       class="px-5 py-3.5 rounded-full bg-amber-400/90 text-amber-950 font-semibold text-sm shadow-lg hover:bg-amber-300 hover:-translate-y-0.5 transition">
                        Acesso Cidadão
                    </a>
                ...
                {{-- Atalhos secundários --}}
                <div class="mt-10 flex flex-wrap items-center justify-center gap-x-6 gap-y-2 text-sm text-indigo-200">
        ...
        <footer class="relative border-t border-white/10 py-5 text-center text-xs text-indigo-300">
