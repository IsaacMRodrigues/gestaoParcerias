    ...
    <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <form method="POST" action="{{ route('portal.osc.store') }}" class="space-y-8">
                ...
                <div class="grid grid-cols-1 gap-4">
                    <div>
                        ...
                        <input id="osc_name" name="osc_name" type="text" required
                               value="{{ old('osc_name') }}"
                               class="block w-full border-gray-300 rounded-lg shadow-sm focus:ring-indigo-500 focus:border-indigo-500 text-sm @error('osc_name') border-red-300 @enderror">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input id="cnpj" name="cnpj" type="text" required
                                   ...
                                   class="block w-full border-gray-300 rounded-lg shadow-sm focus:ring-indigo-500 focus:border-indigo-500 text-sm @error('cnpj') border-red-300 @enderror">
                        ...
                        <div>
                            ...
                            <select id="tipo" name="tipo" required
                                    class="block w-full border-gray-300 rounded-lg shadow-sm focus:ring-indigo-500 focus:border-indigo-500 text-sm @error('tipo') border-red-300 @enderror">
                    ...
                    <div class="grid grid-cols-3 gap-4 pt-2 border-t border-gray-100">
                        ...
                        <div class="col-span-2">
                            ...
                            <input id="cidade" name="cidade" type="text" required value="{{ old('cidade') }}"
                                   class="block w-full border-gray-300 rounded-lg shadow-sm focus:ring-indigo-500 focus:border-indigo-500 text-sm @error('cidade') border-red-300 @enderror">
                            @error('cidade') <p class="text-red-600 text-xs mt-1">{{ $message }}</p> @enderror
                        </div>
                        <div>
                            <label for="estado" class="block text-sm font-medium text-gray-700 mb-1">Estado *</label>
                            <select id="estado" name="estado" required
                                    class="block w-full border-gray-300 rounded-lg shadow-sm focus:ring-indigo-500 focus:border-indigo-500 text-sm @error('estado') border-red-300 @enderror">
            ...
            <div class="flex items-center justify-between">
                ...
                <button type="submit"
                        class="px-6 py-3 text-sm font-semibold text-white bg-indigo-600 rounded-lg hover:bg-indigo-700 transition">
