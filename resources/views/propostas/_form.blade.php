...
<div class="grid grid-cols-2 gap-4 mt-4">
    <div>
        ...
        <x-text-input id="valor_solicitado" name="valor_solicitado" type="number" step="0.01" min="0"
                      class="mt-1 block w-full" value="{{ old('valor_solicitado', $proposta?->valor_solicitado) }}" required />
    ...
    <div>
        ...
        <x-text-input id="valor_proprio" name="valor_proprio" type="number" step="0.01" min="0"
                      class="mt-1 block w-full" value="{{ old('valor_proprio', $proposta?->valor_proprio ?? 0) }}" />
